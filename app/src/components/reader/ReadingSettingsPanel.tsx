      ...
      <div className="p-4 space-y-5">
        ...
        <div>
          ...
          <select
            ...
            className="w-full h-8 px-2 text-ui-sm font-body bg-background border border-input rounded-md text-foreground focus:outline-none focus:ring-1 focus:ring-ring"
          >
            {FONT_FAMILIES.map((f) => (
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="w-7 h-7 flex items-center justify-center rounded-md border border-input text-muted-foreground hover:text-foreground hover:bg-accent transition-colors text-ui-sm"
            >
              A
            </button>
            <input
            ...
            <button
              ...
              className="w-7 h-7 flex items-center justify-center rounded-md border border-input text-muted-foreground hover:text-foreground hover:bg-accent transition-colors text-ui-base font-bold"
            >
              A
            </button>
          </div>
