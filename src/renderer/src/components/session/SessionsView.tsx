  ...
  if (sessions.length === 0) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center text-center p-6">
        ...
        <p className="text-ui-lg text-foreground mb-2">No Sessions Yet</p>
  ...
  return (
    <div className="flex-1 overflow-y-auto">
      <div className="p-6 space-y-6 max-w-[900px]">
        <div>
          <h1 className="text-ui-xl font-semibold text-foreground">Sessions</h1>
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {session.session_type === 'study' && (
                      <span className="shrink-0 px-1.5 py-0.5 text-[10px] font-medium rounded bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300">
                        Focus
                      </span>
                    )}
                ...
                {onOpenBook && (
                  <button
                    onClick={() => onOpenBook(session.book_id)}
                    className="shrink-0 p-1.5 rounded hover:bg-gray-100 dark:hover:bg-gray-800 text-muted-foreground hover:text-foreground transition-colors"
                    title="Open book"
                  >
