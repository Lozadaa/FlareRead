...
function createRain(ctx: AudioContext, output: GainNode): SoundscapeNodes {
  ...
  // High-frequency patter - filtered white noise
  ...
  // Mid rumble - low filtered noise for depth
...
function createCoffeeShop(ctx: AudioContext, output: GainNode): SoundscapeNodes {
  ...
  // Background murmur - filtered pink noise
  ...
  // Subtle clinking/ambience - high-frequency filtered
...
function createFireplace(ctx: AudioContext, output: GainNode): SoundscapeNodes {
  ...
  // Base crackle - brown noise with bandpass
  ...
  // Pop/snap layer - high-frequency white noise bursts
...
function createForest(ctx: AudioContext, output: GainNode): SoundscapeNodes {
  ...
  // Bird chirps layer - high frequency filtered noise
  ...
  // Rustling leaves - mid-high filtered noise
